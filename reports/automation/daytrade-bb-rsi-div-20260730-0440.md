...
- slug: `daytrade-edge-30m-div-adx-v1`
- hypothesis: BTC 30m classic+hidden OR (HL/LL3 RSI) @ BB lower with ADX<25 → long; exit BB upper only.
- hypers: tf=30m, adx_max=25, div_lookback=3
...
- bar D: PASS
- deploy_status: none
- ledger.next_priority: Encode daytrade-edge-30m-div-v1: classic+hidden OR @ BB lower → BB upper on 30m (drop ADX). No deploy. Keep promoted cards frozen.
