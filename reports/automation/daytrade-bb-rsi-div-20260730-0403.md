...
- slug: `daytrade-edge-15m-div-v2`
- hypothesis: BTC 15m classic bull (LL+RSI HL3) OR hidden bull (HL+RSI LL3) @ BB lower → long; exit BB upper only.
...
- bar C: PASS
- bar D: PASS
- ledger.next_priority: Encode daytrade-edge-15m-div-v3: ONE ATR or ADX gate hyper on classic+hidden OR base to cut W1 bleed. No deploy. Keep v1+v2 frozen.
