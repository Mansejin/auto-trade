# 10m-div-atr-adx-hold-v1 PASS

- slug: `daytrade-edge-10m-div-atr-adx-hold-v1`
- hypothesis: BTC 10m ADX<25 + ATR expand (atr>atr offset 3) + classic+hidden OR (HL/LL3 RSI) @ BB lower → long; take_profit null; exit BB upper only.
...
- ledger.next_priority: Encode daytrade-edge-20m-div-v1: 20m classic+hidden OR @ BB lower → upper only (TF between 10m PASS and 30m sparse fail). No deploy. Keep promoted cards frozen.
