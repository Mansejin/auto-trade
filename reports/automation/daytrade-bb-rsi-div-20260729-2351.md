# daytrade-bb-rsi-div 런 리포트 — 2026-07-29 23:51 UTC

## 카드
- slug: `daytrade-bb-rsi-div-v38`
- 가설: BTC daytrade long-only: classic bull (low LL5 + RSI HL5) at/below BB lower with RSI>signal; exit BB middle only.
- hypers: pattern=classic_ll_hl5_rsi_gt_signal_at_lower, exit=bb_mid_only, div_lookback=5
...
| 항목 | 결과 |
|------|------|
| A ≥2/3 net>0 & (PF≥1.2 or zero-loss) | FAIL (0/3; W1 net=0·0trades, W2/W3 net− PF0) |
...
- slug: `daytrade-bb-rsi-div-v39` (JSON 저장·validate OK, 백테스트는 다음 런)
- 구조 변경: classic LL/HL5+RSI>signal@lower→mid 제거 → soft bull LL/HL4 + low≤BB lower + green close; 청산 BB upper or RSI≥55
- next_action: soft LL/HL4 green @lower → upper/RSI55 — v39 백테스트.
