...
- hypothesis: BTC 15m short-proxy: (classic bear HH+RSI LH3 OR hidden bear LH+RSI HH3) @ BB upper → buy; exit BB lower; inverted SL/TP 2.5/0.8 so proxy net tracks short.
- hypers: tf=15m, div_lookback=3, side=short-proxy-inv-sltp
...
- bar D: PASS
- deploy_status: none
- ledger.next_priority: Encode daytrade-edge-15m-div-hold-v1: v1 hidden bull HL+RSI LL3 @ BB lower → BB upper only, take_profit null. No deploy. Keep v1–v3 frozen.
