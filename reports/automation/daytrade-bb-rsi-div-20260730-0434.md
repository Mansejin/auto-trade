# atr-adx-hold-v1 PASS

- slug: `daytrade-edge-15m-div-atr-adx-hold-v1`
- hypothesis: BTC 15m classic+hidden OR (HL/LL3 RSI) @ BB lower with ADX<25 and ATR expanding (atr14 > atr offset 3) → long; exit BB upper only; take_profit null.
...
- ledger.next_priority: Encode daytrade-edge-30m-div-atr-adx-v1: ADX<25 + ATR expand + classic+hidden OR @ BB lower → BB upper on 30m TF. No deploy. Keep promoted cards frozen.
