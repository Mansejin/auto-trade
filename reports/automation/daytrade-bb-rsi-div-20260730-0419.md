...
- slug: `daytrade-edge-15m-div-hold-v1`
- hypothesis: BTC 15m hidden bull (price HL3 + RSI LL3) @ BB lower → long; exit BB upper only; take_profit null so upper-primary hold.
- hypers: tf=15m, div_lookback=3, take_profit=null
- fail_mode: null (PASS)
...
- ledger.next_priority: Encode daytrade-edge-15m-div-atr-v1: ONE ATR gate hyper on hidden-bull v1 base @ BB lower → BB upper. No deploy. Keep v1–v3+hold-v1 frozen.
